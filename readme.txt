...
Contributors: p0rthas, lysyiweb
Tags: form builder, free form builder, online form builder, contact form builder, contact form, survey creator, survey form, order form, order form creator, registration form, registration form builder, custom form, custom form builder, donation form, quiz form, application form, application form builder, booking form builder, booking form, payment form, form maker, request form, feedback form, Poll Form
...
Drag & drop form builder with lead generation and workflow automation. 
MightyForms is a contact form builder, survey creator, order form creator, among other forms creations you need. You can get feedback, fill in PDF forms, and more custom web forms. All-in-one kind of solution

== Description ==
 

**[MightyForms Form Builder](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** is the best solution for web developers and business owners alike that want to build forms for one or more websites. It’s free to use to create forms with unlimited fields and submissions.

Create beautiful contact forms, application forms, email subscription forms, order forms, payment forms, surveys, booking form, and more with a powerful, no-code form builder with **[features](https://www.mightyforms.com/features/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** that help you automate your workflow and [grow your business](https://www.mightyforms.com/blog/form-builder-to-grow-your-business/) with lead generation.

<iframe width="560" height="315" src="https://www.youtube.com/embed/F4xZHrI9JEE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

###📈 Marketing & Sales Automation Form Builder
We created **MightyForms** to solve problems no other form builder was looking to solve. [This is our story](https://www.mightyforms.com/about-us/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress). If you want to solve productivity and workflow automation with your online forms - you’re in the right place. 
...
**[MightyForms](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** is a form creator that automatically [makes online forms responsive](https://www.mightyforms.com/responsive-forms/?utm_source=wp-repo&utm_medium=MF-responsive&utm_campaign=wordpress), you can even preview your form in different devices before publishing it, so you can be assured that your responsive form will be 100% mobile-friendly and easy to fill out on any device. 
...
**[MightyForms Form Builder](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** works seamlessly with the WordPress Gutenberg editor. Simply choose to add a block and select MightyForms.
...
**[MightyForms](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** the web form [drag and drop editor](https://www.mightyforms.com/features/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress) is incredibly easy to use. Simply select and drag the field you would like to add to your form and drop it wherever you like, you can then resize and reposition it if you need to. MightyForm is just this simple as an online form builder solution.
...
[Set up an autoreply](https://www.mightyforms.com/autoresponder/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress) that sends a customized email to each user that responded to your form. You can determine which fields are required to be filled out before submission and enable reCaptcha V3 to protect your form from bots.
...
Make sure you are offering the best possible service and experience by listening to your audience. Create easy-to-fill-out feedback forms with **[MightyForms](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**.
...
Use personalized fields to let your target audience better understand your business and give their helpful opinion. Surveys are an excellent tool, especially for sectors such as **[Marketing & Sales](https://www.mightyforms.com/sales-and-marketing-automation/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** and **[Human Resources](https://www.mightyforms.com/human-resources-automation/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**.


###‎️‍🔥 Online Poll Form
Get closer to the prospect and understand better their needs and demands using a poll form. You can conduct polls to evaluate your business performance and improve it through the data collected. You can even create a **[unique URL](https://help.mightyforms.com/en/articles/3816635-how-to-make-a-custom-url-for-forms-and-surveys?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**  to share them as their own on social media, for example. This makes a personalized poll form.
...
###👋 Request Forms
Order forms, service request forms, booking forms, donation form, all of these request forms can be built with **[MightyForms](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** free form builder. Trust the best form maker platform on the market to build your request form. 
...
Choose a **[custom form builder](https://www.mightyforms.com/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**  to build custom forms for your business.
...
With **[Stripe integration](https://www.mightyforms.com/forms-with-stripe-payments?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** you can have all the payments or donations made through the form, making it easier for both the customer, or donor, and you.
...
Each submission can be automatically sent to you as a filled PDF form straight to your inbox. Or, if you prefer, you can always download each individual filled out PDF from your form’s dashboard. This solution is especially [ideal for lawyers and other legal professionals](https://www.mightyforms.com/legal-document-automation/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress) that rely on PDF document automation. 


###🎯 Form Abandonment Recovery

As an online form builder solution, we care about how you follow your form’s performance and bring to you the best and easy way. **[Abandoned Form Recovery feature](https://www.mightyforms.com/form-analytics-real-time-data-capture?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** is one of MightyForms most powerful premium features. Keep track of each submission as it’s being filled out, even if the user abandons the form you can see the information that was input up until then. It’s easy to enable and can be disabled at any time. 
...
###Do you like MightyForms? :)

Follow us on Social Media: 
[Twitter](https://twitter.com/MightyForms), 
[Facebook](https://twitter.com/MightyForms),
[Instagram](https://www.instagram.com/mightyforms/), 
[Linkedin](https://www.linkedin.com/company/mightyforms/)

[Subscribe to our newsletter](https://www.mightyforms.com/blog/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)

Rate us on [Wordpress](https://wordpress.org/support/plugin/mightyforms/reviews/?filter=5/#new-post)
...
Learn more about our [Pricing](https://www.mightyforms.com/pricing?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress). And if you’re a non-profit organization, get in touch with us, we can work on the best offer for your institution.
...
You can build any form you need. It can be from scratch or you can use one of our several **[free templates](https://www.mightyforms.com/form-templates/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**.
...
You can contact MightyForms in more than just one way. You can send us a message through our **[contact form](https://www.mightyforms.com/contact-mightyforms-support?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**, or send your questions through our Live Chat support.

###Do I need to download the MightyForms plugin to use it on WordPress?
No. You can create a MightyForms account over at [app.mightyforms.com](https://app.mightyforms.com/create-form?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress), create and publish your form there, then copy the Embed code generated and paste it into your WordPress site pages.
...
Your question is not listed? Search for it in our **[help center](https://help.mightyforms.com/en/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)** or get in **[touch with us](https://www.mightyforms.com/contact-mightyforms-support/?utm_source=wp-repo&utm_medium=referral&utm_campaign=wordpress)**

== Third party services usage ==

MightyForm wordpress plugin connects to your MightyForms account through API to retrieve your existing forms and to display them in your website. Our service app can be accessed at https://app.mightyforms.com
- Terms of Use: [https://help.mightyforms.com/pricing-privacy-terms/terms-of-use](https://help.mightyforms.com/pricing-privacy-terms/terms-of-use)
- Privacy Policy: [https://help.mightyforms.com/pricing-privacy-terms/privacy-policy](https://help.mightyforms.com/pricing-privacy-terms/privacy-policy)
...
1. MightyForms animation 
2. MightyForms intergration with WordPress
3. WordPress integration (Gutenberg)
4. WordPress integration (Gutenberg 2)
...
= 1.3.7 =
* Added info-block for Safari users

= 1.3.6 = 
* Added "Reconnect" button for removing API key from the Wordpress

= 1.3.5 =
* Renamed menu items
* Fixed broken link in Readme
* Added "Create form" button if forms is absent in account
* Small fixes

= 1.3.4 =
* Fixed jQuery Migrate deprecation notice
...
= 1.3.1 =
* Added guest-mode for unauthorized users
* Fixed wrong error message on "My forms" page when user haven't forms in MightyForms account

= 1.3 =
* Added "Rate us" widget

= 1.2.4 =
* Added async to loader script. Decreased forms loading time

= 1.2.3 = 
* Analytics

= 1.2.2 =
* Fixed catching API key for "My forms" page
...
= 1.1.1 =
* Fixed getting API key

= 1.1 =
* Removed "settings" page, instead, user stay authorized in plugin, after success auth in MightyForms application, inside of plugin.

= 1.01 =
* API URLs was changed
